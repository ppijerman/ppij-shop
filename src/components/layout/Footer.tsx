...
const COLUMNS = [
  ...
  { title: 'Legal', links: [{ href: '/terms', label: 'Terms & Conditions' }, { href: '/privacy', label: 'Privacy Policy' }, { href: '/impressum', label: 'Impressum' }, { href: '/shipping', label: 'Shipping Policy' }, { href: '/returns', label: 'Return Policy' }] },
];
