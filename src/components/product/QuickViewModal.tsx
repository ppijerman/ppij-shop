...
function AddBtn({
  ...
  return (
    <button
      ...
      style={{ background: (disabled || isAdmin) ? 'var(--muted)' : hovered ? 'var(--accent)' : 'var(--black)', color: 'var(--cream)', border: 'none', padding: '15px', fontFamily: 'var(--font-mono)', fontSize: 12, letterSpacing: '0.22em', textTransform: 'uppercase', cursor: (disabled || isAdmin) ? 'not-allowed' : 'pointer', borderRadius: 999, transition: 'background 0.2s, color 0.2s' }}
    >
