...
export async function getAllBundles(includeInactive = false) {
  const res = await db.query(`
    SELECT
      b.id, b.name, b.price, b.original_price, b.slug, b."desc", b.sku, b.is_active, b.display_order, b.created_at, b.updated_at,
